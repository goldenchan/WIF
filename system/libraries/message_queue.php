...
class Message_Queue 
{
	...
	function __construct($pheanstalk_host=null)
	{
		...
		if(!$this->msg_queue_obj->getConnection()->isServiceListening())
			throw new Exception('No message queue service listening!');
	}
	...
	*/
	...
	function __call($method, $args){
		call_user_func_array(array($this->msg_queue_obj, $method), $args);
	}
